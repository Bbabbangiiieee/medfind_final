				...
				<div>
					<?php
						...
						on med_pharm.med_name = medicine.med_id
  						...
  						on med_pharm.pharmacy = pharmacy_details.pharm_id
  						where  medicine.med_name LIKE '%$search%' or med_desc LIKE '%$search%'
										...
										<a href='pharm_details.php?id=$med_id'>
											<div class='product'>
												<div class='product-img'>
													<img src='./image/$image' style='max-height: 200px;'>
												</div>
